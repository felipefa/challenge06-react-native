# Challenge 06 - GoStack Bootcamp

React native app made to consume Github API, implementing new functionalities to [this app](https://github.com/felipefa/first-react-native), according to following instructions.
...
![WebView](assets/web-view-example.png)
